...
- [ ] T011 [P] [US1] Create Django app `trees` in src/trees/
- [ ] T012 [P] [US1] Create Django app `labels` in src/labels/
- [ ] T013 [P] [US1] Create Django app `exports` in src/exports/
- [ ] T014 [P] [US1] Create Django app `core` in src/core/
- [ ] T015 [US1] Create src/core/shogi/ modules (position.py, rules.py, exceptions.py, __init__.py)
...
- [ ] T016 [P] [US2] Write failing test for JosekiTree model in tests/unit/test_models.py
- [ ] T017 [P] [US2] Write failing test for Node model (including ply field and sfen_with_ply property) in tests/unit/test_models.py
- [ ] T018 [P] [US2] Write failing test for Edge model (including self-reference constraint) in tests/unit/test_models.py
- [ ] T019 [P] [US2] Write failing test for Label model (including HEX color validation) in tests/unit/test_models.py
- [ ] T020 [P] [US2] Write failing test for NodeLabel model in tests/unit/test_models.py

### Implementation for User Story 2 (TDD - Green Phase)

- [ ] T021 [US2] Implement JosekiTree model (make T016 pass) in src/trees/models.py
- [ ] T022 [US2] Implement Node model (make T017 pass) in src/trees/models.py
- [ ] T023 [US2] Implement Edge model (make T018 pass) in src/trees/models.py
- [ ] T024 [US2] Implement Label model (make T019 pass) in src/labels/models.py
- [ ] T025 [US2] Implement NodeLabel model (make T020 pass) in src/labels/models.py
- [ ] T026 [US2] Create initial migrations for trees and labels apps
- [ ] T027 [US2] Apply migrations and verify database schema
...
- [ ] T028 [P] [US3] Write failing test for SFEN handling (parse_sfen, normalize_sfen, get_initial_sfen) in tests/unit/test_position.py
- [ ] T029 [P] [US3] Write failing test for move validation (is_legal_move, validate_move, get_legal_moves, apply_move) in tests/unit/test_rules.py

### Implementation for User Story 3 (TDD - Green Phase)

- [ ] T030 [US3] Implement exceptions.py (ShogiError, SfenParseError, InvalidMoveError, IllegalMoveError) in src/core/shogi/exceptions.py
- [ ] T031 [US3] Implement SFEN utilities (make T028 pass) in src/core/shogi/position.py
- [ ] T032 [US3] Implement move validator (make T029 pass) in src/core/shogi/rules.py
...
- [ ] T033 [P] [US4] Create JosekiTreeFactory in tests/factories.py
- [ ] T034 [P] [US4] Create NodeFactory in tests/factories.py
- [ ] T035 [P] [US4] Create EdgeFactory in tests/factories.py
- [ ] T036 [P] [US4] Create LabelFactory in tests/factories.py
- [ ] T037 [US4] Write factory tests to verify object creation in tests/unit/test_factories.py
...
- [ ] T038 Run all unit tests (`uv run pytest tests/unit/`)
- [ ] T039 Verify all success criteria (SC-001 to SC-007) from spec.md
- [ ] T040 [P] Update INSTALLED_APPS in src/joseki/settings.py if not already done
